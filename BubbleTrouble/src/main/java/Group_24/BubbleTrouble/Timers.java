...
public class Timers {
    ...
    private final int levelMaxDuration = 20;
    // Countdown delay before level starts in seconds * 10
    private final int countdownMaxDuration = 10;
    private final int timerSpeed = 100;

    /**
     * Constructor for the timers class.
     * Initializes the timers, but doesn't start them.
     * @param delay - delay before the timer actually starts.
     */
    ...
    /**
     * Return the amount of time left in the level in milliseconds.
     * Multiplies the timerSpeed by the Counter to get the time in ms.
    ...
    /**
     * Returns the max game duration in milliseconds.
     * Multiplies the value with the timerSpeed to get the time in ms.
    ...
    /**
     * Returns the max countdown duration in milliseconds.
     * Multiplies the value with the timerSpeed to get the time in ms.
    ...
    /**
     * ActionListener for the levelTimer timer.
     * Specifies what actions should be executed every timer cycle.
     */
...
//            System.out.println("levelTimerCounter: " + levelTimerCounter);
    ...
    /**
     * ActionListener for the countdownTimer timer.
     * Specifies what actions should be executed every timer cycle.
     */
