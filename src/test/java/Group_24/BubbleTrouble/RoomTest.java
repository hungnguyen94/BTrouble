...
public class RoomTest {
  ...
  /*
   * @Test public void getWallsTest() { ArrayList<Rectangle> walls = new
   * ArrayList<Rectangle>(); walls.add(new Rectangle(0, 0, 1, 800));
   * walls.add(new Rectangle(1123, 0, 1, 800)); assertEquals(walls,
   * room.getWalls());
   * 
   * }
   */
