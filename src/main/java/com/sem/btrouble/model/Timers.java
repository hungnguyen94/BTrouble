...
public class Timers {
  ...
  /**
   * Constructor for the timers class. Initializes the timers, but doesn't start
   * them.
   * 
   * @param delay
   ...
   * timerSpeed by the Counter to get the time in ms.
   * 
  ...
  /**
   * ActionListener for the countdownTimer timer. Specifies what actions should
   * be executed every timer cycle.
   */
